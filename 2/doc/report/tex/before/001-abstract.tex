...
This is the second half of the compiler project. In this part of the project, we will finish the compiler by adding the parser and the semantic rules in order to produce an executable program from a S-COBOL source code.
