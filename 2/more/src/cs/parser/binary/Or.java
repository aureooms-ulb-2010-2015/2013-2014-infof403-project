...
public class Or{
	...
	public Or(IntegerVariable var_0, IntegerVariable var_1, IntegerVariable var_2, String label_0, String label_1){
		this.var_0 = var_0;
		this.var_1 = var_1;
		this.var_2 = var_2;
	...
	public void genCode(){
		...
		new If(this.var_0.getName(), this.label_1, this.label_0);
